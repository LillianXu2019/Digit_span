 ...
 *
 * updated for compatibility with jsPsych 6.1.0 by Rob Olson.
 *
 **/
...
jsPsych.plugins["poldrack-multi-stim-multi-response"] = (function() {
  ...
  //jsPsych.pluginAPI.registerPreload('poldrack-multi-stim-multi-response', 'stimuli', 'image');

  plugin.info = {
    name: 'poldrack-multi-stim-multi-response',
    parameters: {
      response_ends_trial: {
      ...
      timing_gap: {
        ...
        pretty_name: 'timing gap',
        default: 0,
        description: 'Gap between stimuli'
      },
      stimuli: {
      ...
      timing_stim: {
        ...
        default: undefined,
        description: 'array of stimulus durations'
      },
      timing_response: {
        type: jsPsych.plugins.parameterType.INT,
        pretty_name: 'timing response',
        default: -1,
        description: 'Time to wait for response.  If -1, wait indefinitely.'
      },
      timing_post_trial: {
        type: jsPsych.plugins.parameterType.INT,
      ...
      is_html: {
        ...
        pretty_name: 'is html',
        default: false,
        description: 'is stimulus html?  If yes, stimulus is wrapped in a div; if not, in an img'
      },
      prompt: {
